...
class EventForm extends Component {
    ...
    eventForm = (e) => {
      ...
      axios
      .post('/event/form', {event_name: name, event_type: type, event_date: date, event_time: time, event_duration: duration, event_description: description, venue_name: venue, address: address, city: city, state: state, zip_code: zip, booking_price: price, artist_id: this.props.artist.artist_id})
